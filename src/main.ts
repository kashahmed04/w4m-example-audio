...
mainSeekSlider.addEventListener('input', () => {
  ...
  //of when we move the slider (is it because the play automatically maeks the time go on for individual audios
  //but main seek slider does not so we have to put it with one audio to match the timings)**
})
